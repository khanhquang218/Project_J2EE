		...
		<div class="wrapper_of_block">
			<div class="friend_request">
				<div class="friend_request-recommnend_header">
					<p class="friend_request-recommend_title">Đổi mật khẩu</p>
				</div>
				<div style="margin-top: 16px;">
					<div id="message_current_password"
						style="text-align: end; margin-bottom: 3px; color: red;"></div>
					<div class="wrapper_input">
						<label for="currentPassword">Mật khẩu hiện tại:</label> <input
							class="inputtemp" type="password" id="currentPassword"
					...
					<div class="wrapper_input">
						<label for="newPassword">Mật khẩu mới:</label> <input
							class="inputtemp" type="password" id="newPassword"
					...
					<div class="wrapper_input">
						<label for="confirmNewPassword">Nhập lại mật khẩu mới:</label> <input
							class="inputtemp" type="password" id="confirmNewPassword"
					...
					<div style="display: flex; justify-content: end;">
						<button class="btn disable" id="btnSubmitChangePassword"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/change_password.js"></script>
