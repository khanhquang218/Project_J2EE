...
<div class="list_follow">
	<div class="list_follow-list_header">
		<p class="list_follow-list_title">Theo dõi</p>
	</div>
	<div id="list_follow-list_member" class="list_follow-list_member">
		<!-- 		<div class="list_follow-info_member"> -->
		...
		<!-- 				<p class="list_follow-name_child">Danh Vo</p> -->
		<!-- 				<p class="list_follow-friend_child">300 bạn chung</p> -->
		<!-- 			</div> -->
		<!-- 			<div class="list_follow-action_icon"> -->
		<!-- 				<div id="list_follow-action_icon"> -->
		...
		<!-- 							fill="black" /> -->
		<!-- 		            </svg> -->
		<!-- 					<div id="list_follow-box_show_action" -->
		<!-- 						class="list_follow-box_show_action" style="display: none"> -->
		<!-- 						<div class="list_follow-child"> -->
